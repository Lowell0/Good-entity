...
public class RenewalbpApprovedApplicationEntity {
	...
	public RenewalbpApprovedApplicationEntity(int renewalbp_id, String bspermit_no, String permittee,
			...
			String email, Date date_received, Date date_inspection, int inspection_no, int fsic_no, Date fsic_date,
			int amount, int or_no, Date date, String team_leader, ArrayList<String[]>fire_inspectors, String[] recommendation,
			String remarks) {
		super();
