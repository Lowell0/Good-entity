...
public class RenewalbpNoticeCorrectViolationEntity {
	...
	public RenewalbpNoticeCorrectViolationEntity(int renewncv_id, String bspermit_no, String permittee,
			...
			String email, Date date_received, Date date_inspected, int inspection_no, Date ntc_date, int ntc_no,
			Date ntcv_date, int ntcv_no, String team_leader ,ArrayList<String[]> fire_inspector, ArrayList<String[]> defects,
			Date date, String name, String administrative_fine, String status) {
		super();
