...
public class NewbpNoticeComplyEntity {
	...
	public NewbpNoticeComplyEntity(int newnoticecomply_id, String bspermit_no, String permittee, String business_name,
			...
			Date date_received, Date date_inspected, int inspection_no, Date ntc_date, int ntc_no, String team_leader,
			ArrayList<String[]> fire_inspectors, ArrayList<String[]> defects, String name, Date date,
