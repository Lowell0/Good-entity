...
public class RenewalbpAbatementOrderEntity {
	...
	public RenewalbpAbatementOrderEntity(int renewao_id, String bspermit_no, String permittee, String business_name,
			...
			int ntcv_no, Date abatement_date, int abatement_no, String team_leader, ArrayList<String[]> fire_inspector,
			ArrayList<String[]> defects, Date date, String name, String administrative_fine, String status) {
		super();
